import { STATUS_FILERS, GENDER_FILTERS } from '@/stores/slices/mainListSlice/constants'
...
export const MainListSelectFilters: React.FC<IMainListSelectFilters> = ({ onGenderSelectChange, onStatusSelectChange }) => {
    return (
        <div className="row align-items-center justify-content-center h-100">
            <div className="col-6">
                <Form.Select data-testid='main-list-status-select' defaultValue={STATUS_FILERS.empty} aria-label="Default select example" onChange={onStatusSelectChange}>
            ...
            <div className="col-6">
                <Form.Select data-testid='main-list-status-gender' defaultValue={GENDER_FILTERS.empty} aria-label="Default select example" onChange={onGenderSelectChange}>
