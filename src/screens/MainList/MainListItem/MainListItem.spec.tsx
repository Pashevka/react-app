...
describe('MainListItem', () => {
    ...
    it('renders correctly', () => {
        ...
        expect(getByTestId('main-list-item-other')).toHaveTextContent(element.species)
        expect(getByTestId('main-list-item-other')).toHaveTextContent(element.gender)
        expect(getByTestId('main-list-item-other')).toHaveTextContent(element.location.name)
    });
    ...
    it('renders the correct link', () => {
        ...
        expect(getByTestId('main-list-item-link')).toHaveAttribute('href', '/list/1');
    });
    ...
    it('renders the correct image', () => {
        ...
        expect(getByTestId('main-list-item-image')).toHaveAttribute('src', element.image);
    });
});